...
This example demonstrates how to control the onboard WS2812 RGB LED available on the T-CORE-S3-GSM development board. The RGB LED is connected to GPIO 48 and can display different colours by controlling the intensity of its Red, Green, and Blue elements.
