...
Make sure you've completed [**Section 1: Set Up Development Environment**](./micropython-getting-started) through [**Section 3: GPIO Digital Output/Input**](./digital-io) before starting this section.
